...
func main() {
	...
	*/
	...
	invalidArg1 := []string{
		".932..8.", "27.3.85..", ".8.73.254",
		"9758...31", "....74.6.", "6.45.38.7",
		"7....2.48", "32.4...7.", "..8.579..",
	}
	invalidArg2 := []string{
		".867.2..4", ".2.5..8..", "154.9.237",
	...
	*/
	...
	invalidArg4 := []string{
		"..213.748", "8.4.....2", ".178.26..",
		".68.9.27.", ".932....4", "5..46.3..",
		"..9.24.23", "..63..19.", "385..1.2.",
	}
	invalidArg5 := []string{
		"9.46.3..1", "37.1..2.6", "..6..93.4",
		"..13..9.5", "56..91...", "82...461.",
